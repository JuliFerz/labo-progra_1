...
def crear(x, y, ancho, alto):
    # Leer una imagen
    imagen_dona = pygame.image.load(
        "D:/Users/julian/Documents/Julian/UTN/1. Primer cuatrimestre/labo-progra_1/clase_15/CLASE_PYGAME_INTRO/00.png")
