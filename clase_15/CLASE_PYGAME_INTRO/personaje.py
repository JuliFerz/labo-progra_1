...
def crear(x, y, ancho, alto):
    dict_personaje = {}
    dict_personaje["surface"] = pygame.image.load(
        "D:/Users/julian/Documents/Julian/UTN/1. Primer cuatrimestre/labo-progra_1/clase_15/CLASE_PYGAME_INTRO/01.png")
    dict_personaje["surface"] = pygame.transform.scale(
        dict_personaje["surface"], (ancho, alto))
